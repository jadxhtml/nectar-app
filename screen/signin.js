...
export default function SigninScreen(){
    ...
    return (
        <View style={style.container}>
            ...
            <TextInput placeholder="Phone number" keyboardType="numeric" style={style.phoneInput}/>
            <TouchableOpacity>
                <Ionicons name="arrow-forward" style={style.arrowNext} onPress={()=>nav.navigate('verify')}/>
            </TouchableOpacity>
        </View>
    )
};
